...
export const FourthSection = () => {
  ...
  //   const debouncedIntracranialHemorrhages = useDebounce(
  //     intracranialHemorrhages,
  //     500
  //   );
  //   const debouncedMajorSurgeriesOrSevereInjuries = useDebounce(
  //     majorSurgeriesOrSevereInjuries,
  //     500
  //   );
  //   const debouncedSurgicalInterventions = useDebounce(
  ...
  //     });
  //   }, [
  //     debouncedIntracranialHemorrhages,
  //     debouncedMajorSurgeriesOrSevereInjuries,
  //     debouncedSurgicalInterventions,
  //     debouncedMyocardialInfarction,
  //     debouncedStroke,
  //     debouncedArterialPuncture,
  //   ]);
