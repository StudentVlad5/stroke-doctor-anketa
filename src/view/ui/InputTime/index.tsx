            ...
            <div className={s.InputTime}>
                <div className={classNames(s.hour, s.timeBox)}>
                    <input type="text" placeholder={"00"} inputMode='numeric'
                           maxLength={2}
                           value={valueHh}
                           onKeyPress={validate} onChange={(e) => onChangeHandlerHh(e, onChangeHh)} onBlur={onBlurHh} {...otherProps}/>
                    <span className={s.title}>Hour</span>
                </div>
                <div className={s.delimiter}>:</div>
                <div className={classNames(s.hour, s.timeBox)}>
                    <input type="text" placeholder={"00"}
                           maxLength={2} onKeyPress={validate} inputMode='numeric'
                           onChange={(e) => onChangeHandlerMm(e, onChangeMm)} value={valueMm} onBlur={onBlurMm} {...otherProps} />
